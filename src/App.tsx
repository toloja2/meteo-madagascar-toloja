...
function App() {
  ...
  if(weatherMain === "clear"){
    background = "from-orange-100 via-sky-300 to-orange-100"
  }
  ...
  return (
    <div className={`min-h-screen flex justify-center items-center bg-linear-to-br ${background} transition-all duration-1000 ease-in-out `}>
      <div className="animation-fadeIn bg-white/50 border border-white/30 backdrop-blur-3xl p-8 rounded-3xl shadow-2xl w-[95%] max-w-lg text-white transition duration-500 hover:scale-105 hover:shadow-yellow-500/50">
        <h1 className="text-center font-extrabold mb-6 text-2xl bg-linear-to-r from-yellow-500 to-white bg-clip-text text-transparent"> Météo Madagascar </h1>
        ...
        { weather && (
          ...
          <img src={`https://api.openweathermap.org/img/wn/${weather.weather[0].icon}.png`} alt='image icon' className='my-10 text-center mx-auto' />
